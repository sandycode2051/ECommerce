...
$error_message = "";
$khalti_public_key = "test_public_key_eba4d1f2b1614473b5534d9fe1877fde";
...
$successRedirect = "index.php"; // change this url , it will be the page user will be redirected after successful payment
...
<div class="khalticontainer">
    ...
    <center>
        <div><img src="assets/imgs/khalti.png" alt="khalti" width="200"></div>
    </center>
    <?php
    if ($token == "") {
